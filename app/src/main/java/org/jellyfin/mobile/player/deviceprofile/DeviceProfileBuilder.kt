...
class DeviceProfileBuilder(
    ...
    fun getDeviceProfile(
        preferredVideoCodec: String? = appPreferences.preferredTranscodeVideoCodec,
        preferredAudioCodec: String? = appPreferences.preferredTranscodeVideoAudioCodec,
        preferFmp4Hls: Boolean = appPreferences.preferFmp4HlsContainer,
    ): DeviceProfile {
